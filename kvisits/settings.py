...
KVISITS_IGNORE_HANDLERS = getattr(settings, 'KVISITS_IGNORE_HANDLERS', ['kvisits.ignorehandlers.noignorehandler.NoIgnoreHandler'])
KVISITS_COUNTER_HANDLER = getattr(settings, 'KVISITS_COUNTER_HANDLER', 'kvisits.counterhandlers.nocounterhandler.NoCounterHandler')
