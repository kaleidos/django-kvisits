...
KVISITS_IGNORE_USER_AGENTS = getattr(settings, 'KVISITS_IGNORE_USER_AGENTS', [])
KVISITS_BOTS_USER_AGENTS = getattr(
        settings,
        'KVISITS_BOTS_USER_AGENTS',
        [
...
KVISITS_OBJECTS_AS_COUNTERS = getattr(settings, 'KVISITS_OBJECTS_AS_COUNTERS', True)
KVISITS_LOG_ENABLED = getattr(settings, 'KVISITS_LOG_ENABLED', False)
KVISITS_LOG_HANDLER = getattr(settings, 'KVISITS_LOG_HANDLER', 'kvisits.loghandlers.nologhandler.NoLogHandler')
KVISITS_UNIQ_HANDLER = getattr(settings, 'KVISITS_UNIQ_HANDLER', 'kvisits.uniqhandlers.nouniqhandler.NoUniqHandler')
KVISITS_IGNORE_HANDLER = getattr(settings, 'KVISITS_IGNORE_HANDLER', 'kvisits.ignorehandlers.noignorehandler.NoIgnoreHandler')
